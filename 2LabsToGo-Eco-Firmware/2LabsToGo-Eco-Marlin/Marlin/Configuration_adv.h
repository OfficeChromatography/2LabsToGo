...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN 41                  // Override the default pin if needed
 ...
 * and .1 to reset the workspace to native machine space.
 */
 ...
 *  -  will revert to its behavior from Marlin 1.0.
 */
