...
class GcodeGenerator:
    ...
    #pos_vial9= "G0Z145" #rinse bottle
    #pos_vial8= "G0Z268.5" #vial 8
    #pos_vial7= "G0Z254.5" #vial 7
    #pos_vial6= "G0Z240.5" #vial 6
    #pos_vial5= "G0Z226.5" #vial 5
    #pos_vial4= "G0Z212.5" #vial 4
    #pos_vial3= "G0Z198.5" #vial 3
    #pos_vial2= "G0Z184.5" #vial 2
    #pos_vial1= "G0Z170.5" #vial 1
    #pos_rinbot= "G0Z145" #rinse bottle
    ...
    #esto comente para hacer la prueba de los viales
    def static_cleaning(self, times, frequency):
        ...
        self.down_sample()
        self.finish_moves()
        #self.check_temperature_humidity()
    ...
    # code to collect drops in the vial - to test
    # def static_cleaning(self, times):
    #     '''Rinse an amount of times with the rinsing solution'''
    #     self.check_return("M92Z400")
    #     self.check_return("M203Z65")
    #     self.check_return("M42P49S0")
    #     self.check_return("M42P36S0") 
    #     self.check_return("G28X")
    #     self.check_return("G0X1")
    #     self.check_return("G28YZ")
    #     self.check_return("M400")
    #     self.check_return(self.pos_rinbot)
    ...
    #         i = 0
    #         while (i < 50):
    #             self.open_valve_frequency(1400)
    #             self.wait_ms(200)
    #             i += 1
    #         self.close_val        for i in range(times):
    #         self.increase()
    #     #self.up()
    #     self.finish_moves()
    ...
    # def rinsing_warmup(self,frequency):
    #     '''Rinse 8 times with the rinsing solution and then warm up the nozzle with 600 drops'''
    #     self.check_return("G0X1")
    #     self.check_return(self.pos_rinbot)
    #     self.down()
    #     self.finish_moves()
    ...
    # def sample_rinsing_1(self):
    #     '''Rinse two times with the sample'''
    #     self.open_valve()
    #     i=0    
    #     while (i < 3):
    #         self.start_pump()
    ...
    # def warmup(self,frequency):
    #     '''Warm up the nozzle with almost 300 drops of rinsing solution'''
    #     self.check_return("G0X1")
    #     self.check_temperature_humidity()
    #     self.open_valve()
    #     self.start_pump()
    ...
    # def application_1_sample(self,frequency): #example with the first sample
    #     '''Application process with the first sample only. It makes five lines'''
    #     self.check_return("G0X1")
    #     self.check_return(self.positions[6])
    #     self.down()
    #     self.sample_rinsing(frequency)
    #     for a in range(5): 
    #         self.start_pump()
    #         self.stop_pump()
    #         for x in self.lista1:
    #             self.check_return("G0X1{}Y10".format(x))
    #             self.open_valve_frequency(frequency)
    #     self.up()
    #     self.rinsing()  
    ...
    def application(self, frequency, list_of_bands, waitTime, speed, list_sample, rinsingPeriod, nozzlediameter):
        ...
        self.check_return("M42P49S0")  # z-switch
        self.check_return("M42P36S0")  # 3-way valve switch
        # self.check_return("M42P41S255")  # case light
        # self.check_temperature_humidity()
     i = 0
    temp = 0
    mod = 0
    ...
    for band in list_of_bands:
        ...
        if i == 0 or list_sample[i] != list_sample[i-1]:  # Nadel nur bewegen, wenn neues Vial
            self.check_return("G0X1F5000")
    ...
    #def application(self,frequency,list_of_bands,waitTime,speed,list_sample):
        #self.check_temperature_humidity()
        #i = 0
        #for band in list_of_bands:
            #self.check_return(self.positions[list_sample[i]-1])
            ...
            #self.finish_moves()    
            #self.sample_rinsing(frequency)
            #self.sample_rinsing_1()
            #direction_y = 0
            #for list_of_points in band:
                #self.increase() #build up the pressure before the application of each LINE
                #for point in list_of_points:
                    #if (direction_y - point[0]) > 0:
                        #self.wait(waitTime)
                    #self.linear_move_xy(point[0]+11, point[1], speed)
                    #self.finish_moves()
                    #self.open_valve_frequency(frequency)
                    #self.wait_ms(200)
                    #self.finish_moves()
            ...
            #self.up()
            #self.finish_moves()         
            #self.rinsing()  #rinsing the pump and valve
            #i += 1
